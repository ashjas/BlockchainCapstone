...
contract Pausable is Ownable {
    ...
    {
        require(state != _paused,"State already set");
        _paused = state;
        if(state)
...
//    @dev Approves another address to transfer the given token ID
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender,"to account should not be the sender.");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId),"failed require for _isApprovedOrOwner.");
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory _data) public {
        ...
        require(_checkOnERC721Received(from, to, tokenId, _data),"failed require for _checkOnERC721Received.");
    }
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId],"Only owner of the token can transfer ownership");
        // TODO: require token is being transfered to valid address
        require(from != address(0),"from address cant be NULL");
        require(to != address(0),"to address cant be NULL");
        // TODO: clear approval
